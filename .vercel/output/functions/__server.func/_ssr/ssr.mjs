...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-ClVJET43.mjs");
...
var manifest = {
	"1b991017110b873dff846120f8f183891e9b4854a5e709780b653f9532fe5aec": {
		functionName: "syncNowFn_createServerFn_handler",
		importer: () => import("./api-BY8x8gDS.mjs")
	},
	"24e662a23604df0f779641dfaef62cb43b5246b6883e9eb11022e83e4150dac2": {
		functionName: "listBasesFn_createServerFn_handler",
		importer: () => import("./api-BY8x8gDS.mjs")
	},
	"3d36a1b39a2248d23f5e8d3c48ec59ca597cb761fc4d9065c59230958a12c65b": {
		functionName: "getBaseFn_createServerFn_handler",
		importer: () => import("./api-BY8x8gDS.mjs")
	},
	"3ec9b54aaad7d79f944c0d5df8c060223bdb6309d4fc9dedc8c0eb90eff62b34": {
		functionName: "reportBaseFn_createServerFn_handler",
		importer: () => import("./api-BY8x8gDS.mjs")
	},
	"b0077d02d250f2023f251ba3ac7626e2c4842a730432b4003fb948c944cc771c": {
		functionName: "copyBaseFn_createServerFn_handler",
		importer: () => import("./api-BY8x8gDS.mjs")
	},
	"b14c2f976d327c0a01dc247ae918d17c82e23c630d8e7b81cb21534db8760045": {
		functionName: "homeFn_createServerFn_handler",
		importer: () => import("./api-BY8x8gDS.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DZ_dB8j4.mjs").then((n) => n.t),
